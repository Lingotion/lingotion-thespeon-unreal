...
#include "../../Public/Engine/AudioStreamComponent.h"
...
{
public:
    explicit FAudioStreamGenerator(TSharedPtr<FAudioStreamSharedData, ESPMode::ThreadSafe> InShared)
...
void UAudioStreamComponent::SubmitAudio(const TArray<float>& Interleaved)
{
    SubmitAudio(Interleaved.GetData(), Interleaved.Num());
}
