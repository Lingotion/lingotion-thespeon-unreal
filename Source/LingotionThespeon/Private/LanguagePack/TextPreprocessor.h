...
public:
	...
	/**
	 * Preprocesses the input by cleaning the text in-place.
	 * Modifies the Input's Text field directly.
	 * @param Input The ModelInput containing text to preprocess (modified in-place)
	 */
	static void PreprocessInput(FLingotionModelInput& Input);
