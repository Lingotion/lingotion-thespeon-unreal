...
UCLASS(Config=Plugins, DefaultConfig,
       meta=(DisplayName="Lingotion Thespeon"))
...
public:
	...
	static FString GetLicenseKey() { return Get()->LicenseKey; }
	static UEditorThespeonSettings* Get() { return GetMutableDefault<UEditorThespeonSettings>(); }
    UPROPERTY(Config, EditAnywhere, Category="License")
    ELicenseValidationState ValidationState;
    UPROPERTY(Config, EditAnywhere, Category="License", DisplayName="License Key",
            meta=(ToolTip="Enter your Lingotion Thespeon license key"))
    FString LicenseKey;
};
